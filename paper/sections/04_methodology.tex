...
own-squad and opponent top-eleven average prices and
$\phi^{\mathrm{lag}}_i$ is a lagged form feature defined below. The
...
\item \textbf{Squad selection} chooses a 15-player squad maximising
  ...
  per-country cap, and exclusion of eliminated squads.
