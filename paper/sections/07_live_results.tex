...
little better (ensemble 37, GBM 59), a reminder that a two-match
round is close to a coin flip. After the semi-finals the entry stood
...
eventual champion's block -- Sim\'on, Porro, Cubars\'i, and Baena
joined Laporte and Cucurella for six Spain starters -- with the
...
discretion proved right: Kane never played, and the model's one
clear miss was leaving Olise (10 points, started and scored) on the
bench of the model-guided eleven. The matches themselves split the
forecaster's scorecard: the final went to the modal outcome (Spain
1--0, forecast 54\%), while the bronze produced the tournament's
wildest scoreline, England 6--4 over the 59\%-favoured France -- a
miss, though Mbapp\'e's hat-trick within the loss returned 17 raw
points, doubled to 34 as captain, the entry's largest single return
of the tournament. The round realised \FinalRoundNet{} points net,
the entry's best of all eight: the six Spain starters banked the
clean sheet plus the booster's twelve, and the season closed at
\TotalUserActualNet{} net points and global rank \GlobalRankFinal{},
up from \GlobalRankSF{} after the semi-finals -- roughly a
quarter-million places gained on the final round alone.
