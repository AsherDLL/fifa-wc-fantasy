...
the game's worldwide entries after its best round of the tournament
(\FinalRoundNet{} points) came last, on a squad built by six
model-recommended transfers into the eventual champion's defensive
block.
