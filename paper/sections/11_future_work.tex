...
throughout the tournament \POSTFINAL{confirm snapshot corpus covers
group stage through final}; after the final we scrape the closed
...
\POSTFINAL{release date and repository link}. Publishing the decision
