...
% by `make final-check`.
\newcommand{\POSTFINAL}[1]{\textcolor{red}{\textbf{[POST-FINAL: #1]}}}
...
weight rather than the anchoring role it is usually given.
\POSTFINAL{final results sentence: closing cumulative totals, the
entry's final global rank, and the realized outcome of the locked
final-round plan}
\end{abstract}
