...
all developed and validated during the tournament itself.
\POSTFINAL{results sentence: cumulative points vs baselines, final
league outcome, headline negative results}
\end{abstract}
